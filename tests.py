...
erlang_term_binaries = [
    ...
    # atom true
    (True, bool, b'\x83w\x04true'),
    # atom false
    (False, bool, b'\x83w\x05false'),
    # atom none
    (None, type(None), b'\x83w\x04none'),
    # small integer
    (123, int, b'\x83a{'),
    # integer
    (12345, int, b'\x83b\x00\x0009'),
    # float
    (1.2345, float, b'\x83F?\xf3\xc0\x83\x12n\x97\x8d'),
    # tuple
    ((Atom("foo"), b"test", 123), tuple, b'\x83h\x03w\x03foom\x00\x00\x00\x04testa{'),
    # dict
    ({Atom("foo"): 123, b"test": True}, dict, b'\x83t\x00\x00\x00\x02w\x03fooa{m\x00\x00\x00\x04testw\x04true'),
    # list
    ([1024, b"test", 4.096], list, b'\x83l\x00\x00\x00\x03b\x00\x00\x04\x00m\x00\x00\x00\x04testF@\x10bM\xd2\xf1\xa9\xfcj'),
    ...
    # reference
    (Reference('nonode@nohost', [33, 0, 0], 0), Reference, b'\x83r\x00\x03w\rnonode@nohost\x00\x00\x00\x00!\x00\x00\x00\x00\x00\x00\x00\x00'),
    # port
    (Port('nonode@nohost', 455, 0), Port, b'\x83fw\rnonode@nohost\x00\x00\x01\xc7\x00'),
    # pid
    (PID('nonode@nohost', 31, 0, 0), PID, b'\x83gw\rnonode@nohost\x00\x00\x00\x1f\x00\x00\x00\x00\x00'),
    # function export
    (Export('jobqueue', 'stats', 0), Export, b'\x83qw\x08jobqueuew\x05statsa\x00'),
]
