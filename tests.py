...
erlang_term_binaries = [
    ...
    # atom undefined
    (None, type(None), '\x83d\x00\tundefined'),
    # # byte list
    ...
    # small big that is Python long integer on 32-bit, integer on 64-bit
    (123456789012, (long, int), '\x83n\x05\x00\x14\x1a\x99\xbe\x1c'),
    # large big
